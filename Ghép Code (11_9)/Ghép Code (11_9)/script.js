...
/*QUOTES*/  
const quotes = ["Failure is not the opposite of the success. It's a part of success.", "Ideation without execution is delusion.", "Dream is not which you see while sleeping, it is something that does not let you sleep.", "It always seems impossible until it's done.", "The only place where success comes before work is in the dictionary."]
var quotes_index = 0;
var length = 0 
